package sample.webfluxes.deltaindexer.service;
...
import sample.webfluxes.core.exception.IndexFailedException;
...
public class DeltaIndexService {
    ...
    public DeltaIndexService(RestHighLevelClient client) {

        this.client = client;
    }

    public Mono<String> index(String index, String id) {
                        ...
                        request, RequestOptions.DEFAULT, new ActionListener<IndexResponse>() {
                            ...
                            public void onResponse(IndexResponse response) {
                                ...
                                if (shardInfo.getFailed() > 0) {
                                    ...
                                    sink.error(new IndexFailedException());
                                    return;
                                }
